...
// A 256-color map for byte visualization
pub const VIRIDIS_MAP: [[u8; 3]; 256] = [
...
// Returns the (x, y) coordinate on an n x n Hilbert grid for the given index d.
// The algorithm requires n to be a power of 2.
